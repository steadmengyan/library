                ...
                <tbody>
                    <!--<tr v-for="(list, index) in listsTable" :key="index">
                     ...
                     <tr >
                        ...
                        <td>
                            <span @click="dakuan_btn(list, 1)" class="chakan">打款</span>
                            <span @click="dakuan_btn(list, 2)" class="chakan">拒绝</span>
                            <span @click="dakuan_btn(list.audit_state)" class="chakan">查看</span>
                        </td>
                    </tr>
                </tbody>
            </table>
