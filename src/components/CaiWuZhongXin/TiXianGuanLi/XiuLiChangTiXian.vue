<template>
    <div class="XiuLiChangTiXian">
        <header class="content_title">
              <ul class="title_box">
                  <li class="title_box_left">
                      <span class="line_title"></span>
                        <span class="name_title"> &nbsp;修理厂提现</span>
                  </li>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr v-for="(list, index) in listsTable" :key="index">
                        ...
                        <td>
                            <span  @click="dakuan_btn(list, 1)" v-if="list.audit_state == 1" class="chakan">打款</span>
                            <span @click="dakuan_btn(list, 2)" v-if="list.audit_state == 1" class="chakan">拒绝</span>
                            <span @click="see_it(list)" v-if="list.audit_state == 2" class="chakan">查看</span>
                        </td>
                    </tr>
                </tbody>
            </table>
                        ...
                        <ul class="box_dakuan Top20">
                            ...
                            <li  class="two">
                                ...
                                <div v-if="dakuang_status" @click="img_addBtn()">
                                    <img v-if="success_receipt" :src="success_receipt" style="max-width:300px;">
        ...
        <!-- 模态框（Modal） 查看-->
        <div class="modal fade" id="myModal_seeIt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content" style="width:800px;">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="box_dakuan Top20">
                            ...
                            <li  class="two">
                                ...
                                <div v-if="dakuang_status" @click="img_addBtn()">
                                    <img  :src="success_receipt" style="max-width:300px;">
                                </div>
                                <div v-else>
                                    <textarea v-model="rejectReason" class="form-control" rows="3" name=textarea style="max-width:300px;"></textarea>
                                </div>
...
export default {
    ...
    methods: {
        ...
        post_dakuan: function(num){
            ...
            if(num == 1){
                aaa.state = '2' // 审核通过
                aaa.success_receipt = this_1.success_receipt
            }else if(num == 2){
                aaa.state = '3' // 驳回
        ...
        see_it: function (list) {
            var this_1 = this
            $("#myModal_seeIt").modal('show')
            this_1.openBank = list.openBank
            this_1.bankNumber = list.bankNumber
            this_1.companyName = list.companyName
            this_1.id = list.id
            this_1.success_receipt = list.success_receipt
            this_1.rejectReason = list.rejectReason
        }
    },
    mounted () {
        var this_1 = this
